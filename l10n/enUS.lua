...
L["ACTIONS_CLEARED_COMPLETE"] = "Action slots cleared %s complete in %.4f seconds"
L["CLEARING_ACTIONS_START"] = "Begin: Start clearing action slots"
L["MOUNT_CANNOT_BE_PLACED"] = "Mounts are not handled."
L["COMMAND_HELP_HELP"] = "List available commands."
L["COMMAND_MACRO_HELP"] = "Manage macros."
L["COMMAND_BARS_HELP"] = "Manage action bars."
L["COMMAND_BINDINGS_HELP"] = "Manage key bindings."
